...
class PolyDemo extends JFrame {
	...
	// the purpose of this class is solely to support the JFrame class above, and I
	// don't want it reused in arbitrary contexts, so by nesting this class here
	// I can indicate the intent a bit more clearly that this class "goes with" the
	// class above it
	...
	public class PolyDemoPanel extends JPanel {
		 ...
		 * advantage of polymorphism, we coded
		 * this "in general" with respect to the superclass, and not specific to any
		 * subclass.
		 *********************************************************************************************************************/
		...
		public Shape getRandShape() {
			...
			switch ((int) (Math.random() * 5)) {
				case 0:
					...
					break;
				case 1:
					retVal = new Spray(x, y);// Default Spray
					break;
				case 2:
					retVal = new Kirby(x, y, getRandInt()); // Makes Kirby
					break;
				case 3:
					retVal = new Circle(x, y, getRandInt()); // Shape from Lab
					break;
				case 4:
					retVal = new PokeBall(x, y, getRandInt()); // Made pokeball
					// new Spray( x,y );
			}
